...
export function Services() {
  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-stone-brown/50 to-stone-brown/30 border-y border-golden-beige/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="group relative bg-gradient-to-br from-golden-beige/15 to-stone-brown/50 border border-golden-beige/30 rounded-2xl overflow-hidden hover:border-blessed-yellow/50 transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="relative p-6 sm:p-8">
              {/* Icon */}
              <div className="w-16 h-16 bg-blessing-green/20 border border-blessing-green/40 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <MapPin size={32} className="text-blessing-green" />
              </div>

              {/* Title & Description */}
              <h3 className="text-xl sm:text-2xl font-bold text-golden-beige mb-3">
                Pickup at Counter
              </h3>
              <p className="text-sacred-white/70 text-sm sm:text-base mb-6">
                Fresh, hot biryani prepared to order. Quick pickups with guaranteed freshness.
              </p>

              {/* Benefits */}
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2 text-sacred-white/80 text-sm">
                  <span className="w-2 h-2 bg-blessed-yellow rounded-full"></span>
                  Easy & Quick Pickup
                </li>
                <li className="flex items-center gap-2 text-sacred-white/80 text-sm">
                  <span className="w-2 h-2 bg-blessed-yellow rounded-full"></span>
              ...
              <div className="bg-stone-brown/60 border border-golden-beige/20 rounded-lg p-4 mb-6">
                <div className="flex items-center gap-2 mb-2">
                  <Clock size={16} className="text-blessed-yellow" />
                  <span className="text-sacred-white/80 text-xs font-semibold">Ready in</span>
                </div>
                <p className="text-2xl font-bold text-blessed-yellow">15-20 min</p>
                <p className="text-sacred-white/60 text-xs mt-1">Estimated pickup time from order</p>
              </div>

              {/* Location Map/Info */}
              <div className="bg-stone-brown/80 rounded-lg overflow-hidden mb-6 border border-golden-beige/20 h-40">
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 bg-black/30 flex items-end p-4">
                    <div>
                      <p className="text-blessed-yellow font-semibold text-sm">ETAT ASMAKAM</p>
              ...
              <Link
                href="/order"
                className="block w-full luxury-gradient text-stone-brown font-semibold py-3 rounded-lg text-center text-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Order for Pickup
              </Link>
            </div>
          ...
          <div className="group relative bg-gradient-to-br from-golden-beige/15 to-stone-brown/50 border border-golden-beige/30 rounded-2xl overflow-hidden hover:border-blessed-yellow/50 transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="relative p-6 sm:p-8">
              {/* Icon */}
              <div className="w-16 h-16 bg-divine-red/20 border border-divine-red/40 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Truck size={32} className="text-divine-red" />
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between bg-stone-brown/60 border border-golden-beige/20 rounded-lg p-3">
                  <span className="text-sacred-white/80 text-xs font-medium">Avg. Delivery</span>
                  <span className="text-blessed-yellow font-bold">45-60 min</span>
                </div>
                <div className="flex items-center justify-between bg-stone-brown/60 border border-golden-beige/20 rounded-lg p-3">
                  <span className="text-sacred-white/80 text-xs font-medium">Free Delivery</span>
                  <span className="text-blessing-green font-bold">✓</span>
                </div>
                <div className="flex items-center justify-between bg-stone-brown/60 border border-golden-beige/20 rounded-lg p-3">
                  <span className="text-sacred-white/80 text-xs font-medium">Live Tracking</span>
                  <span className="text-blessing-green font-bold">✓</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Link
                  href="/track"
                  className="block w-full border-2 border-blessed-yellow text-blessed-yellow font-semibold py-3 rounded-lg text-center text-sm hover:bg-blessed-yellow/10 transition-all duration-300"
                >
                  Track Your Order
                </Link>
              </div>
          ...
          <div className="group relative bg-gradient-to-br from-golden-beige/15 to-stone-brown/50 border border-golden-beige/30 rounded-2xl overflow-hidden hover:border-blessed-yellow/50 transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="relative p-6 sm:p-8">
              {/* Icon */}
              <div className="w-16 h-16 bg-blessed-yellow/20 border border-blessed-yellow/40 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <ChefHat size={32} className="text-blessed-yellow" />
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3 bg-stone-brown/60 border border-golden-beige/20 rounded-lg p-3">
                  ...
                  <div className="text-xs">
                    ...
                    <p className="text-blessing-green font-semibold">Based on your budget</p>
                  </div>
                </div>
              </div>
