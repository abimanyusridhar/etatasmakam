...
import { Instagram, Twitter, Facebook, Mail, Phone, MapPin, MessageSquare } from "lucide-react"
...
export function Footer() {
  ...
  return (
    <>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 text-blessed-yellow group">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-sacred-white/90 leading-relaxed text-sm">
                      ETAT ASMAKAM,<br />
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blessed-yellow hover:text-divine-red transition-colors inline-flex items-center gap-2 mt-3 font-semibold text-sm"
                    >
                      Get Directions
              ...
              <div className="space-y-4">
                <div className="space-y-2 text-sacred-white/90">
                  <p className="flex justify-between">
                    ...
                    <span className="text-blessed-yellow font-semibold">24/7</span>
                  </p>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 border-blessed-yellow/50 bg-blessed-yellow/10 hover:bg-blessed-yellow/20 hover:border-blessed-yellow/70 transition-all duration-300 text-blessed-yellow font-semibold text-sm group"
                >
      ...
      {/* Feedback Form Modal */}
      {showFeedback && <FeedbackForm isOpen={showFeedback} onClose={handleFeedbackClose} />}
    </>
  )
}
